                ...
                <div className="md:grid-cols-2 gap-6">
                    ...
                    <div className="mb-10 group p-6 bg-zinc-900/30 border border-white/10 rounded-xl transition-all duration-300 hover:border-purple-500/50 hover:shadow-[0_0_20px_rgba(168,85,247,0.1)] relative">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
                                ...
                                <h3 className="text-xl font-bold text-white group-hover:text-purple-400 transition-colors">Languages & Core</h3>
                            </div>
                    ...
                    <div className="mb-10 group p-6 bg-zinc-900/30 border border-white/10 rounded-xl transition-all duration-300 hover:border-green-500/50 hover:shadow-[0_0_20px_rgba(34,197,94,0.1)] relative">
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-3 mb-6 border-b border-white/10 pb-4">
                                ...
                                <h3 className="text-xl font-bold text-white group-hover:text-green-400 transition-colors">Full Stack Web</h3>
                            </div>
                            <div className="flex flex-wrap gap-3">
                                <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 cursor-default">HTML5</span>
                                <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 cursor-default">CSS3</span>
                                <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 cursor-default">React.js</span>
                                <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 cursor-default">React Redux</span>
                                <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 cursor-default">Tailwind CSS </span>
                                ...
                                <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 cursor-default">Authentication & Authorization</span>
                                <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 cursor-default">MongoDB</span>
                                <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 cursor-default">PostgreSQL</span>
                                <span className="bg-green-500/10 text-green-400 border border-green-500/20 px-3 py-1 rounded-md text-sm hover:bg-green-500/20 cursor-default">Prisma ORM</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mb-10 group p-6 bg-zinc-900/30 border border-white/10 rounded-xl transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.1)] relative">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-wrap gap-3">
                                <span className="bg-blue-500/10 text-blue-400 border border-blue-500/20 px-3 py-1 rounded-md text-sm hover:bg-blue-500/20 cursor-default">Arduino</span>
                                <span className="bg-blue-500/10 text-blue-400 border border-blue-500/20 px-3 py-1 rounded-md text-sm hover:bg-blue-500/20 cursor-default">ESP32</span>
                                <span className="bg-blue-500/10 text-blue-400 border border-blue-500/20 px-3 py-1 rounded-md text-sm hover:bg-blue-500/20 cursor-default">PLC Programming</span>
                    ...
                    <div className="mb-10 group p-6 bg-zinc-900/30 border border-white/10 rounded-xl transition-all duration-300 hover:border-orange-500/50 hover:shadow-[0_0_20px_rgba(249,115,22,0.1)] relative">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                <span className="bg-orange-500/10 text-orange-400 border border-orange-500/20 px-3 py-1 rounded-md text-sm hover:bg-orange-500/20 cursor-default">Windows & Ubuntu</span>
                                ...
                                <span className="bg-orange-500/10 text-orange-400 border border-orange-500/20 px-3 py-1 rounded-md text-sm hover:bg-orange-500/20 cursor-default">Agentic AI Workflows</span>
                            </div>
                        </div>
                    </div>
